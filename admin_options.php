...
<body>
  ...
  <!--/.preloader-->
    ...
    <center><h2 class="head" style="color:#09C;" >USER ENTERIES</h2></center>
<body style="font-size:20px; color:#0033FF;">
<center>
<pre style="background-color:#09C; height:400px;">
<br />
<form name="f1"  method="post" action="admin_options.php">
<input type="radio" name="c1" value="detail" /> User Detail<br />
<input type="radio" name="c1" value="feed" /> User Feedback<br />
<input type="radio" name="c1" value="expert" /> Expert Needed<br />
<input type="radio" name="c1" value="order" /> Ordered Products<br />
<input type="radio" name="c1" value="service" /> Services Provided<br /><br /><br />	
...
if(isset($_POST['b1']))
{
    ...
    switch($choice)
	{
		case "detail":
		{
			...
			header('location:admin_options_userdetail.php');
			break;
		}
		case "feed":
		{
		 	header('location:admin_options_feedback.php');
			break;
		}
		case "expert":
		{
		 	header('location:admin_options_expert.php');
			break;
		}
		case "service":
		{
  	     	header('location:admin_options_services.php');
			break;
		}
		case "order":
		{
  	     	header('location:admin_options_order.php');
			break;
		}
    }
