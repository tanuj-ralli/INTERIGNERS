...
<form name="f1" action="admin_fetch_order.php" method="post">
    <center>
	<br/><br><br><br>
...
if(isset($_POST['b1']))
{
  ...
  if($conn == true)
  {
     $sql = "SELECT * FROM orderd WHERE email='$e'";
	 echo"<center><table border=2 cellpadding=5 cellspacing=3>";
	 echo"<th>Email<td>Name</td><td>Product ID</td><td>Payment Method</td></th>";
