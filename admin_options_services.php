...
<body>
  ...
  <!--/.preloader-->
    ...
    <center><h2 class="head" style="color:#09C;" >Services</h2></center>
<body style="font-size:20px; color:#0033FF;">
<center>
<pre style="background-color:#09C; height:400px;">
<br />
<form name="f1"  method="post" action="admin_options_services.php">
...
if(isset($_POST['b1']))
{
    ...
    switch($choice)
	{
		case "insert":
        {
			...
			header('location:admin_insert_service.php');
			break;
		}
		case "fetch":
		{
		    //echo"<a href=fetch1.php></a>";
			header('location:admin_fetch_service.php');
			break;
		}
		case "delete":
		{
		 	header('location:admin_delete_service.php');
			break;
		}
		case "update":
		{
		 	header('location:admin_update_service.php');
			break;
		}
		case "view":
		{
  	     	header('location:admin_view_service.php');
			break;
		}
    }
