...
<form name="f1" action="admin_fetch_service.php" method="post">
    <center>
	<br/><br><br><br>
	Enter the Product ID whose information is needed : <input type="number" name="t1" class="ema" required/><br /><br/> 
...
if(isset($_POST['b1']))
{
  ...
  if($conn == true)
  {
	 ...
	 echo"<th>Product Code<td>Category</td><td>Company Name</td><td>Feature</td><td>Price</td><td>Image Reference</td></th>";
