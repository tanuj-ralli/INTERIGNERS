	 ...
	 { 
	    if($result->num_rows>0)
		{
		     while($rw=$result->fetch_array())
			 {
			     ...
			     echo"<center><a href=emi.php?id=".$rw[0]."&ee=".$e."><h3 class=log> Buy this Product. </h3></a></center>";
			 }
		}
		else
		{
            ...
            <div class="col-sm-6">
              <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <ul class="address">
                  ...
                  <li><i class="fa fa-envelope"></i> <span> Email:</span>tanujralli97@gmail.com</li>
                  <li><i class="fa fa-globe"></i> <span> Website:</span> <a href="#">www.interignerscompany.com</a></li>
                </ul>
              </div>                            
            </div>
          </div>
