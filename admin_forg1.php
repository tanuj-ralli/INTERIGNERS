...
<form name="f1" action="admin_forg1.php" method="post">
<center>
<pre style="background-color:#09C; height:350px;">
Type your Answer :<input type="text" name="e1" class="ema" required ><br>
...
if(isset($_POST['b1']))
{
  ...
  if($ans==$rww[4])
  {
     session_start();
	 $_SESSION['ps']=$rww;
	 header('location:admin_forg2.php');
  }
  else
  {
