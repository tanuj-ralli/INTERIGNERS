...
<form name="f1" action="admin_update_service.php" method="post">
...
<input type="submit" name="b1" value="UPDATE to data base." class="log"/>
...
if(isset($_POST['b1']))
{
  ...
  if($conn == true)
  {
     $sql = "SELECT * FROM services WHERE productcode='$pc'";
	 ...
	 { 
	    if($result->num_rows>0)
		{
			 ...
			 {
                 $sql1= "UPDATE services set productcode='$pc', category='$cat', companyname='$cn', feature='$f', price='$p', image='$ir' where productcode='$pc'";
