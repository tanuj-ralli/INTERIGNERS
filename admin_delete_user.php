...
<form name="f1" action="admin_delete_user.php" method="post">
    <center>
	<br/><br><br><br>
	Enter the Email whose rocord is to be deleted : <input type="email" name="t1" class="ema" required /><br /><br/> 
  ...
  if($conn == true)
  {
	 ...
	 { 
	    if($result->num_rows>0)
		{
			 ...
			 {
			     $sql1= "DELETE FROM userdetail WHERE email='$e'";
