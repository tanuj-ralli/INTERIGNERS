...
<form name="f1" action="admin_options_expert.php" method="post">
    <center>
	<h2 style="color:#FFF;">Expert Requirement</h2>
	<br/>
	</center>
</form>
...
<?php
{
  ...
  if($conn == true)
  {
	 ...
	 echo"<th align=center>Name<td>Email</td><td>Address</td><td>Phone no.</td><td>Message</td></th>";
	 ...
	 { 
	    if($result->num_rows>0)
		{
			 ...
			 {
			     echo"<tr align=center><td>".$rw[0]."</td><td>".$rw[1]."</td><td>".$rw[2]."</td><td>".$rw[3]."</td><td>".$rw[4]."</td></tr>";
			 }
		}
		else
		{	
