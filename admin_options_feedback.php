...
<body style="font-size:20px; color:#FFFFFF; background-color:#09c;  ">
<form name="f1" action="admin_options_expert.php" method="post">
    <center>
	<h2 style="color:#FFF;" >Anonymous Feedback</h>
	<br/>
	</center>
</form>
...
<?php
{
  ...
  if($conn == true)
  {
     $sql = "SELECT * FROM anonymousfeedback";
	 echo"<center><table border=2 cellpadding=5 cellspacing=3>";
	 echo"<th align=center>Name<td>Email</td><td>Subject</td><td>Message</td></th>";
	 ...
	 { 
	    if($result->num_rows>0)
		{
			 ...
			 {
			     echo"<tr align=center><td>".$rw[0]."</td><td>".$rw[1]."</td><td>".$rw[2]."</td><td>".$rw[3]."</td></tr>";
			 }
		}
		else
		{	
